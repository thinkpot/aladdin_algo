"""
Django settings for neuralwave project.
...
SECRET_KEY = 'django-insecure-n_eg)mj=a85^po#_o7=_cv#h%s@8%8^skerzq@haf9h2j!$0-6'
...
WSGI_APPLICATION = 'neuralwave.wsgi.application'
